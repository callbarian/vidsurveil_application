...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.push_extract_1.setGeometry(QtCore.QRect(40, 10, 141, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.lcdNumber = QtWidgets.QLCDNumber(self.mini_viewer)
        self.lcdNumber.setGeometry(QtCore.QRect(20, 50, 64, 23))
        self.lcdNumber.setObjectName("lcdNumber")
        self.lcdNumber_2 = QtWidgets.QLCDNumber(self.mini_viewer)
        self.lcdNumber_2.setGeometry(QtCore.QRect(480, 50, 64, 23))
        self.lcdNumber_2.setObjectName("lcdNumber_2")
        self.lcdNumber_4 = QtWidgets.QLCDNumber(self.mini_viewer)
        self.lcdNumber_4.setGeometry(QtCore.QRect(250, 50, 64, 23))
        self.lcdNumber_4.setStyleSheet("font: 13pt \".AppleSystemUIFont\";\n"
"font: 13pt \".AppleSystemUIFont\";")
        self.lcdNumber_4.setObjectName("lcdNumber_4")
        self.lcdNumber_5 = QtWidgets.QLCDNumber(self.mini_viewer)
        self.lcdNumber_5.setGeometry(QtCore.QRect(690, 50, 64, 23))

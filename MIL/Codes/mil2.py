...
class MIL():
    def __init__(self,path_name,temp_dir,save_dir,env_path_c3d,env_path_mil):
        ...
        #caffe root
        self.caffe_root = os.getcwd() +'/MIL/C3D/C3D-v1.0'
    ...
    def extract_frames(self,video, start_frame, frame_dir, num_frames_to_extract=16):
    ...
    def run_C3D_extraction(self,feature_prototxt, ofile, feature_layer, trained_model):
    ...
    def generate_feature_prototxt(self,out_file, src_file, mean_file=None):
    ...
    def main(self,file_path,video_file):
            ...
            if return_code == 0:
                ...
                with open(os.path.join(c3d_feature_outdir,video_id+".txt"),'w') as f:
                    for vec in Segments_Features:
                        ...
                        rec = rec + "\n"
                        f.write(rec)
                print ("[Info] Saving output as {}".format(video_id+'.txt'))
